...
mouseClicked(()=>{
    ...
    if(isInside(mouse,{x:centerX-(310/2)+leftward,y:centerY-(116/2)-extraBoostUp+(130*4),width:640,height:116})){window.location = "./basic/german/index.html"}
